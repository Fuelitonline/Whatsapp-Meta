    ...
    window.FB.login(
      (response) => {
        ...
        if (response.authResponse) {
          ...
          // For WhatsApp Embedded Signup, the code comes via postMessage
          ...
          <div className="md:grid md:grid-cols-5">
            ...
            <div className="p-8 md:col-span-3">
              ...
              <div className="mb-4 p-3 bg-blue-50 rounded text-sm space-y-1">
                <div>Facebook SDK: <span className={fbLoaded ? "text-green-600 font-medium" : "text-yellow-600"}>
                  {fbLoaded ? "✅ Loaded" : "⏳ Loading..."}
                </span></div>
                <div>App ID: <span className="text-gray-600">{import.meta.env.VITE_FACEBOOK_APP_ID ? "✅ Set" : "❌ Missing"}</span></div>
                <div>Config ID: <span className="text-gray-600">{import.meta.env.VITE_FACEBOOK_CONFIG_ID ? "✅ Set" : "❌ Missing"}</span></div>
              </div>
