...
exports.embeddedLogin = async (req, res) => {
    ...
    try {
        ...
        const tokenUrl = `https://graph.facebook.com/${process.env.WHATSAPP_API_VERSION || 'v20.0'}/oauth/access_token`;
        ...
        const meResponse = await axios.get(
            `https://graph.facebook.com/${process.env.WHATSAPP_API_VERSION || 'v20.0'}/me`,
            {
                params: {
        ...
        const phoneResponse = await axios.get(
            `https://graph.facebook.com/${process.env.WHATSAPP_API_VERSION || 'v20.0'}/${waba.id}/phone_numbers`,
            { 
                params: { 
                    access_token: systemUserAccessToken 
                },
        ...
        try {
            await axios.post(
                `https://graph.facebook.com/${process.env.WHATSAPP_API_VERSION || 'v20.0'}/${waba.id}/subscribed_apps`,
                {
